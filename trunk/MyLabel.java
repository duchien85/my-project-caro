...
public class MyLabel extends Widget {
	...
	public MyLabel (Skin skin) {
		this("", skin);
	}

	public MyLabel (String text, Skin skin) {
	 ...
	 * color. */
	public MyLabel (String text, String fontName, Color color, Skin skin) {
	 ...
	 * skin. */
	public MyLabel (String text, String fontName, String colorName, Skin skin) {
		this(text, new LabelStyle(skin.getFont(fontName), skin.getColor(colorName)), null);
	}

	public MyLabel (String text, LabelStyle style) {
		this(text, style, null);
	}

	public MyLabel (String text, LabelStyle style, String name) {
		super(name);
		if (text == null) text = "";
		this.text = text;
		setStyle(style);
